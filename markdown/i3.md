...
Feel free to copy bits and pieces. The full file has some aliases and functions that will be unusable to people other than myself. This is more for my own benefit / backup. I recommend taking a look the [environments](environments) page to get a breakdown of the useful bits and pieces.
...
bindsym $mod+d exec --no-startup-id rofi -show drun -show-icons -icon-theme paper
